	...
	<div class="container">
		...
		<div class="font-size">
			      <ul class="nav navbar-nav navbar-right masthead-nav">
					...
					<li><a href="viewfav.php"> <span class="glyphicon glyphicon-heart" aria-hidden="true" size="50px"></span></a></li>
			        <li><a href="viewcart.php"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span></a></li>
					
<li><a href="index2.php"><span class="glyphicon glyphicon-home" aria-hidden="true" data-toggle="popover" title="Popover title" data-content="And here's some amazing content. It's very engaging. Right?"></span></a></li>
			...
			<a href="#" class="navicon"></a>
				<div class="toggle">
					<ul class="toggle-menu">
						...
						<li><a  href="editprofile.php"> Manage Profile</a></li>
