		...
		<div class="service-top">
			<div class="col-md-5 service-top animated wow fadeInLeft" data-wow-duration="1000ms" data-wow-delay="500ms">
				<div class=" service-grid">
					...
					<div class="col-md-6 service-grid1">
						<div class="hi-icon-wrap hi-icon-effect-5 hi-icon-effect-5a">
							<a href="famous.php" class="hi-icon hi-icon-mobile glyphicon glyphicon-globe"></a>
				...
				<div class=" service-grid">
					<div class="col-md-6 service-grid1">
						<div class="hi-icon-wrap hi-icon-effect-5 hi-icon-effect-5a">
							<a href="book1.php" class="hi-icon hi-icon-mobile glyphicon glyphicon-list-alt"></a>
							<p><b>Book a table</b></p>
						</div>					
						</div>
					<div class="col-md-6 service-grid1">
						<div class="hi-icon-wrap hi-icon-effect-5 hi-icon-effect-5a">
							<a href="index1.php" class="hi-icon hi-icon-mobile glyphicon glyphicon-home" ></a>
							<p><b>Home</b></p>
						</div>					
						</div>
					<div class="clearfix"> </div>
			...
			<div class="col-md-7 service-bottom animated wow fadeInRight" data-wow-duration="1000ms" data-wow-delay="500ms">
				...
				<div class=" service-bottom1">
					...
					<div class="ser-top "> 
						...
						<p>Find Famous Food of Restaurants..</p>
					</div>
					<div class="clearfix"> </div>
				</div>
				<div class=" service-bottom1">
