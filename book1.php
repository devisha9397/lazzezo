...
<h4>Select Restaurant:</h4><select class="form-control" name="txtrest_id">
  <?php 

  $obj2=new database();
  $res2=$obj2->restaurant();
...
?>
			...
			<br>
							Enter date: <input type="date"  value="<?php echo $date; ?>" class="form-control" name="txtdate" readonly/>
